...
public class mathq extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mathq);
        ...
        numVidButton.setOnClickListener(v -> {
            Intent vidIntent = new Intent(mathq.this, mathvid.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mathq.this, activitymath1.class);
        ...
        buttonMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (age != null && age.equals("6")) {
                    ...
                    Intent homeIntent = new Intent(mathq.this, more_age6.class);
                    ...
                    Intent homeIntent = new Intent(mathq.this, more.class);
                    homeIntent.putExtra("EXTRA_USERNAME", username);
                    homeIntent.putExtra("EXTRA_GENDER", gender);
                    homeIntent.putExtra("EXTRA_AGE", age);
                    startActivity(homeIntent);
