...
public class colq extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_colq);
        ...
        numVidButton.setOnClickListener(v -> {
            Intent intent = new Intent(colq.this, colvid.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(colq.this, activitycolor1.class);
                startActivity(intent);
                finish();
        ...
        buttonNum.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(colq.this, home.class);
