...
public class activitycolor5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activitycolor5);
...
//        gifImageView.setImageResource(R.drawable.my_gif); //
            ...
            public void onClick(View v) {
                if (currentQuestion == 1) {
                    if (question1RadioGroup.getCheckedRadioButtonId() == R.id.question1_answer1) {
                        Toast.makeText(activitycolor5.this, "Question 1: Correct! Way To Go!!!", Toast.LENGTH_SHORT).show();
                        nextButton.setVisibility(View.VISIBLE);
                        submitButton.setVisibility(View.GONE);
                    } else {
                        Toast.makeText(activitycolor5.this, "Question 1: Incorrect. Try Again", Toast.LENGTH_SHORT).show();
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(activitycolor5.this, activitycolor6.class);
