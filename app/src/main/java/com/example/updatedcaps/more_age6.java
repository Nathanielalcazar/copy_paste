...
public class more_age6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_more_age6);
        ...
        imageButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent mathqIntent = new Intent(more_age6.this, mathq.class);
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Navigate to the mathq activity and pass the Intent extras
                Intent mathqIntent = new Intent(more_age6.this, scienceq.class);
                mathqIntent.putExtra("EXTRA_USERNAME", username);
                mathqIntent.putExtra("EXTRA_GENDER", gender);
                mathqIntent.putExtra("EXTRA_AGE", age);
                startActivity(mathqIntent);
        ...
        imageButton3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Navigate to the mathq activity and pass the Intent extras
                Intent mathqIntent = new Intent(more_age6.this, animalq.class);
                mathqIntent.putExtra("EXTRA_USERNAME", username);
                mathqIntent.putExtra("EXTRA_GENDER", gender);
                mathqIntent.putExtra("EXTRA_AGE", age);
                startActivity(mathqIntent);
        ...
        imageButton4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Navigate to the mathq activity and pass the Intent extras
                Intent mathqIntent = new Intent(more_age6.this, storieq.class);
                mathqIntent.putExtra("EXTRA_USERNAME", username);
                mathqIntent.putExtra("EXTRA_GENDER", gender);
                mathqIntent.putExtra("EXTRA_AGE", age);
                startActivity(mathqIntent);
        ...
        iconPf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(more_age6.this, logout.class);
                startActivity(intent);
            }
        });

        // Set up an OnClickListener for the button_more ImageButton
        ImageButton buttonMore = findViewById(R.id.imageButton7);
        buttonMore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Create an Intent to start the home activity and pass the Intent extras
                Intent homeIntent = new Intent(more_age6.this, home2.class);
