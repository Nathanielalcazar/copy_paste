...
public class activityscience5 extends AppCompatActivity {
    ...
    private int incorrectAttempts = 0; // new variable to count incorrect

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_activityscience5);
...
//        gifImageView.setImageResource(R.drawable.my_gif); //
            ...
            public void onClick(View v) {
                if (currentQuestion == 1) {
                    if (question1RadioGroup.getCheckedRadioButtonId() == R.id.question1_answer1) {
                        Toast.makeText(activityscience5.this, "Question 1: Correct! Way To Go!!!", Toast.LENGTH_SHORT).show();
                        nextButton.setVisibility(View.VISIBLE);
                        submitButton.setVisibility(View.GONE);
                    } else {
                        Toast.makeText(activityscience5.this, "Question 1: Incorrect. Try Again", Toast.LENGTH_SHORT).show();
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(activityscience5.this, activityscience6.class);
